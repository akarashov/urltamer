...
func (x *URLShortenRequest) Reset() {
	*x = URLShortenRequest{}
	mi := &file_proto_utltamer_proto_msgTypes[0]
...
func (x *URLShortenResponse) Reset() {
	*x = URLShortenResponse{}
	mi := &file_proto_utltamer_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLExpandRequest) Reset() {
	*x = URLExpandRequest{}
	mi := &file_proto_utltamer_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLExpandResponse) Reset() {
	*x = URLExpandResponse{}
	mi := &file_proto_utltamer_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UserURLsResponse) Reset() {
	*x = UserURLsResponse{}
	mi := &file_proto_utltamer_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLData) Reset() {
	*x = URLData{}
	mi := &file_proto_utltamer_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_proto_utltamer_proto protoreflect.FileDescriptor

const file_proto_utltamer_proto_rawDesc = "" +
	"\n" +
	"\x14proto/utltamer.proto\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a\x11.UserURLsResponseB.Z,github.com/akarashov/urltamer/internal/protob\x06proto3"

var file_proto_utltamer_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_utltamer_proto_goTypes = []any{
...
var file_proto_utltamer_proto_depIdxs = []int32{
...
func init() { file_proto_utltamer_proto_init() }
func file_proto_utltamer_proto_init() {
	if File_proto_utltamer_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_utltamer_proto_rawDesc), len(file_proto_utltamer_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_utltamer_proto_goTypes,
		DependencyIndexes: file_proto_utltamer_proto_depIdxs,
		MessageInfos:      file_proto_utltamer_proto_msgTypes,
	}.Build()
	File_proto_utltamer_proto = out.File
	file_proto_utltamer_proto_goTypes = nil
	file_proto_utltamer_proto_depIdxs = nil
}
